...
const rawFamilyTimeline = [
  {
    id: 'tl-001',
    type: 'foundation',
    title: 'Khai khẩn đất tại Phước Long, Sông Bé cũ. Nay là Phường Phước Phước Long Thành Phố Đồng Nai',
    subtitle: 'Di dân vào vùng đất hoang Sông Bé',
    date: '1945-01-01',
    lunarDate: 'Năm Ất Dậu, tháng Chạp',
    era: 'Thời kỳ kháng chiến chống Pháp',
    location: 'Phước Long, Sông Bé cũ (nay là Phường Phước Long, Thành phố Đồng Nai)',
    description:
      'Cụ Lê Tiệm rời quê hương cũ ở Thằng Bình, Quảng Nam, dẫn theo gia quyến vào khai khẩn vùng đất hoang tại Phước Long, Tỉnh Sông Bé. Với đôi bàn tay và ý chí sắt đá, cụ đã biến vùng đất hoang vu thành những thửa ruộng màu mỡ.',
    relatedMembers: ['g1-001', 'g1-002'],
    images: [],
    documents: [],
    quotes: ['Đất đai là máu thịt, là cội rễ của dòng họ — Cụ Lê Tiệm'],
    tags: ['khai hoang', 'lập làng', 'thủy tổ', 'Bình Phước'],
    importance: 5,
  },
  {
    id: 'tl-002',
